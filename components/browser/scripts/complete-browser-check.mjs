...
const CASES = [
  ...
  { id: "J1", title: "search read upgrade inspect journey", timeoutMs: 120_000, paths: [PRIMARY], visual: true, operations: [op("search", "web.search"), op("read", "web.read", { url: "/docs.md" }), op("upgrade", "web.upgrade"), op("open", "browser.create", { pathId: PRIMARY }), op("observe", "browser.observe"), op("visual", "browser.observe", { view: "visual" }), op("artifact", "artifact.read"), op("close", "browser.close")] },
