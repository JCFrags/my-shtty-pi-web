...
EOF
cp "$ROOT/scripts/apparmor.sh" "$ROOT/scripts/dist-manifest.mjs" "$STAGE/scripts/"
...
HOME="$WORK/home" XDG_DATA_HOME="$WORK/home/data" XDG_STATE_HOME="$WORK/home/state" XDG_CACHE_HOME="$WORK/home/cache" TERMINAL_BROWSER_SKILL_OUT="$STAGE/skills" "$ROOT/scripts/generate-skill.sh"
