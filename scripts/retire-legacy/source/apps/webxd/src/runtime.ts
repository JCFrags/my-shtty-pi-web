...
const AUTHORITY_SCOPES = new Set(["system.read", "search.write", "retrieval.read", "artifacts.read"]);
...
export type WebxdCleanupStage = "clients" | "server" | "bindings" | "socket";
...
export class WebxdRuntime {
  ...
  #cleanupState: CleanupState = { clients: false, server: false, bindings: false, socket: false };
  ...
  async start(): Promise<void> {
    ...
    this.#cleanupState = { clients: false, server: false, bindings: false, socket: false };
    this.#server = server;
    try {
