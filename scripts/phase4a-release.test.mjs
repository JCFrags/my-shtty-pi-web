...
test("fixed qualification runner verification requires immutable mode, exact tab authority, ready-checked restoration, and returned-control refresh", () => {
  ...
  releaseInternals.validateFixedQualificationRunner(`const mode = process.argv.length === 3 ? 'soak-4h' : 'acceptance'; const seconds = 14400; ${authority} ${restoration} ${refresh}`);
